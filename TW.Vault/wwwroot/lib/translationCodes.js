...
let translationCodes = {
    ...
    REPORT_BUILDING_DAMAGE_NAMES: "REPORT_BUILDING_DAMAGE_NAMES",
    REPORT_BUILDING_DAMAGE_LEVELS: "REPORT_BUILDING_DAMAGE_LEVELS",
    ...
    TAB_PHONE_NUMBERS: "TAB_PHONE_NUMBERS",
    TAB_SMS_SETTINGS: "TAB_SMS_SETTINGS",
    TAB_STATS: "TAB_STATS",
    TAB_ME: "TAB_ME",
    ...
    SMS_TIME_FORMAT_DESCRIPTION: "SMS_TIME_FORMAT_DESCRIPTION",
    SMS_MESSAGE_REQUIRED: "SMS_MESSAGE_REQUIRED",
    SMS_CHARACTER_LIMIT: "SMS_CHARACTER_LIMIT",
    SMS_INVALID_TIME: "SMS_INVALID_TIME",
    SMS_TIME_TOO_EARLY: "SMS_TIME_TOO_EARLY",
    SMS_ADD_NEW: "SMS_ADD_NEW",
    SMS_SUPPORTED_FORMATS: "SMS_SUPPORTED_FORMATS",
    SMS_INVALID_PHONE_NUMBER: "SMS_INVALID_PHONE_NUMBER",
    SMS_PHONE_NAME_TOO_LONG: "SMS_PHONE_NAME_TOO_LONG",
    SMS_PHONE_NUMBERS: "SMS_PHONE_NUMBERS",
    SMS_ADD_PHONE_NUMBER: "SMS_ADD_PHONE_NUMBER",
    SMS_SETTINGS_1: "SMS_SETTINGS_1",
    ...
    SMS_SETTINGS_2: "SMS_SETTINGS_2",
    SMS_CONFIRM_REMOVE_NUMBER: "SMS_CONFIRM_REMOVE_NUMBER",
    SMS_PHONE_NUMBERS_ERROR: "SMS_PHONE_NUMBERS_ERROR",
    SMS_SETTINGS_EMPTY_VALUE: "SMS_SETTINGS_EMPTY_VALUE",
    SMS_SETTINGS_INVALID_VALUE: "SMS_SETTINGS_INVALID_VALUE",
    SMS_CONFIRM_DELETE_NOTIFICATION: "SMS_CONFIRM_DELETE_NOTIFICATION",
    SMS_NOTIFICATIONS_ERROR: "SMS_NOTIFICATIONS_ERROR",
