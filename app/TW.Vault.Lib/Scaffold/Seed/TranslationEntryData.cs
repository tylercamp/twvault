...
namespace TW.Vault.Scaffold.Seed
{
    public static class TranslationEntryData
    {
        ...
        public static List<TranslationEntry> Contents { get; } = new List<TranslationEntry>
        {
            ...
            new TranslationEntry { TranslationId = 1, KeyId = 370, Value = "(page {numDone}/{numTotal})" },
            ...
            new TranslationEntry { TranslationId = 1, KeyId = 436, Value = "The {buildingName} has" },
            new TranslationEntry { TranslationId = 1, KeyId = 437, Value = "to level {newLevel}" },
            ...
            new TranslationEntry { TranslationId = 1, KeyId = 453, Value = "{hour}:{minute}:{second} on {day}:{month}:{year}" },
            ...
            new TranslationEntry { TranslationId = 1, KeyId = 473, Value = "Gave admin privileges to {playerName}" },
